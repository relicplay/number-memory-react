...
const Start = (props: {level: number; nextLevel: (value: number) => void; setgameStatus: (value: number) => void; maxLevel: number}) => {
    ...
    <div className="slidercontainer">
        ...
        onChange={(e) => {props.nextLevel(Number(e.target.value));}}
        />
